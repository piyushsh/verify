...
Partial Class ProjectMain_Responsive
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Me.CurrentSession.VT_TopTab_Clicked = "" And Me.CurrentSession.VT_Top_CurrentTab = "") Then
            btnTOP_Orders.ImageUrl = "~/App_Themes/TabButtons/Sales-ON.gif"
        ...
        If Me.CurrentSession.VT_TopTab_Clicked <> "" Then
            ...
            Select Case Me.CurrentSession.VT_Top_CurrentTab
                ...
                Case "ORDERS"
                    btnTOP_Orders.ImageUrl = "~/App_Themes/TabButtons/Sales-OFF.gif"
                Case "DETAILS"
                    btnTOP_Details.ImageUrl = "~/App_Themes/TabButtons/Order-Details-OFF.gif"
                Case "DELIVERIES"
                    btnTOP_Deliveries.ImageUrl = "~/App_Themes/TabButtons/Dispatches-OFF.gif"
                Case "PRINTOUTS"
                    btnTOP_Printouts.ImageUrl = "~/App_Themes/TabButtons/Reports-OFF.GIF"
                Case "AUDIT"
                    btnTOP_Contracts.ImageUrl = "~/App_Themes/TabButtons/Audit-Log-Off.GIF"
                Case "SYSTEM-ADMIN"
                    btnTOP_SYSADMIN.ImageUrl = "~/App_Themes/TabButtons/More-OFF.gif"
                Case "PLANNING"
                    btnTOP_Planning.ImageUrl = "~/App_Themes/TabButtons/Planning-Off.gif"
                Case "FULFILL"
                    btnTOP_Fulfill.ImageUrl = "~/App_Themes/TabButtons/Fulfill-Off.gif"
                Case "QUOTES"
                    btnTOP_Quotes.ImageUrl = "~/App_Themes/TabButtons/Quotes-Off.gif"
                Case "CONTRACTS"
                    btnTOP_Quotes.ImageUrl = "~/App_Themes/TabButtons/Contracts-Off.gif"
                Case Else
            ...
            Select Case UCase(Me.CurrentSession.VT_TopTab_Clicked)
                ...
                Case "DETAILS"
                    btnTOP_Details.ImageUrl = "~/App_Themes/TabButtons/Order-Details-On.GIF"
                    Me.CurrentSession.VT_Top_CurrentTab = "DETAILS"

                Case "DELIVERIES"
                    btnTOP_Deliveries.ImageUrl = "~/App_Themes/TabButtons/Dispatches-On.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "DELIVERIES"

                Case "PRINTOUTS"
                    btnTOP_Printouts.ImageUrl = "~/App_Themes/TabButtons/Reports-On.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "PRINTOUTS"

                Case "SYSTEM-ADMIN"
                    btnTOP_SYSADMIN.ImageUrl = "~/App_Themes/TabButtons/More-ON.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "SYSTEM-ADMIN"

                Case "PLANNING"
                    btnTOP_Planning.ImageUrl = "~/App_Themes/TabButtons/Planning-ON.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "PLANNING"

                Case "FULFILL"
                    btnTOP_Fulfill.ImageUrl = "~/App_Themes/TabButtons/Fulfill-On.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "FULFILL"

                Case "QUOTES"
                    btnTOP_Quotes.ImageUrl = "~/App_Themes/TabButtons/Quotes-On.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "QUOTES"

                Case "CONTRACTS"
                    btnTOP_Quotes.ImageUrl = "~/App_Themes/TabButtons/Contracts-On.gif"
                    Me.CurrentSession.VT_Top_CurrentTab = "QUOTES"
                Case Else
    ...
    Protected Sub btnTOP_SYSADMIN_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_SYSADMIN.Click
    ...
    Protected Sub btnTOP_Details_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Details.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Deliveries_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Deliveries.Click
        ClearFormLockAndSaveForm()
        'If Me.CurrentSession.VT_JobID = 0 Then
        '    Dim objDisp As New VT_Display.DisplayFuncs
    ...
    Protected Sub btnTOP_Orders_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Orders.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Printouts_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Printouts.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Planning_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Planning.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Fulfill_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Fulfill.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Quotes_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Quotes.Click
        ClearFormLockAndSaveForm()
    ...
    Protected Sub btnTOP_Contracts_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnTOP_Contracts.Click
        ClearFormLockAndSaveForm()
    ...
    Sub ClearFormLockAndSaveForm()
        ...
        If InStr(Outer_CP.Page.Master.TemplateControl.AppRelativeVirtualPath, "NewOrderMasterNew") Or InStr(Outer_CP.Page.Master.TemplateControl.AppRelativeVirtualPath, "NewOrderMaster") Then
