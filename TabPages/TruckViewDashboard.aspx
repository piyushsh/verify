<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="TruckViewDashboard.aspx.vb"  EnableEventValidation="false" Inherits="TabPages_TruckView" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table class="auto-style1">
                                    <tr>
                                        ...
                                        <td style="width: 600px">
                                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt" ForeColor="Black" Text="Truck Management dashboard   [ Sales Orders ]"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td>
              ...
              <ig:WebDataGrid ID="wdgRepGrid" runat="server"
                  ...
                  <Columns>
                      ...
                      <ig:BoundDataField DataFieldName="Other_CustPO" Key="Other_CustPO" Width="70px"
                       ...
                       <ig:BoundDataField DataFieldName="ProductName" Key="ProductName" Width="50px"
                          DataType="System.String">
                          <Header Text="Product:" />
                      </ig:BoundDataField>
                       <ig:BoundDataField DataFieldName="TraceCodeDesc" Key="TraceCodeDesc" Width="50px"
                          DataType="System.String">
                          <Header Text="Horse:" />

                      </ig:BoundDataField>
                      <ig:BoundDataField DataFieldName="TruckName" Key="TruckName" Width="70px"
                          DataType="System.String">
                          <Header Text="Truck Name:" />
                      </ig:BoundDataField>
                      <ig:BoundDataField DataFieldName="TruckID" Key="TruckID" Width="70px" Hidden ="true" 
                          DataType="System.String">
                          <Header Text="Truck ID:" />
                      </ig:BoundDataField>
                       <ig:BoundDataField DataFieldName="DriverNames" Key="DriverNames" Width="70px"
                          DataType="System.String">
                          <Header Text="Drivers:" />
                      </ig:BoundDataField>
                      <ig:BoundDataField DataFieldName="DriverIds" Key="DriverIds" Width="70px" Hidden ="true" 
                          DataType="System.String">
                          <Header Text="Truck ID:" />

                      </ig:BoundDataField>
                      <ig:BoundDataField DataFieldName="PickUpLocation" Key="PickUpLocation" Width="70px"
                          DataType="System.String">
                          <Header Text="PickUp Location:" />
                      </ig:BoundDataField>
                      <ig:BoundDataField DataFieldName="AltRoute" Key="Destination" Width="70px"
                          DataType="System.String">
                      ...
                      <ig:SummaryRow EmptyFooterText="" SummariesCssClass="SummaryRow">
                          ...
                          <ColumnSettings>
                                   ...
                                   <ig:SummaryRowSetting ColumnKey="SO_ContiguousNum" 
                                     ...
                                     <ig:SummaryRowSetting ColumnKey="TruckName" 
                                         EnableColumnSummaryOptions="False"  ShowSummaryButton="False">
                                    </ig:SummaryRowSetting>
                                     <ig:SummaryRowSetting ColumnKey="TruckId" 
                                         EnableColumnSummaryOptions="False"  ShowSummaryButton="False">
                                    </ig:SummaryRowSetting>
                                    ...
                                    <ig:SummaryRowSetting ColumnKey="DriverNames" 
                                         EnableColumnSummaryOptions="False"  ShowSummaryButton="False">
                                    </ig:SummaryRowSetting>
                               <ig:SummaryRowSetting ColumnKey="DriverIDs" 
                                         EnableColumnSummaryOptions="False"  ShowSummaryButton="False">
                                    </ig:SummaryRowSetting>
