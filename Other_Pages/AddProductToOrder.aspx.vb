...
Partial Class Other_Pages_AddProductToOrder
    Inherits MyBasePage
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnAdd.Click
        ...
        If UCase(Session("VT_FromPage")) = "FULFILL_OPENING" Then
            ...
            objDB.InsertFulfillSOToTrace(Me.CurrentSession.VT_OrderPO, PortalFunctions.Now, Me.CurrentSession.VT_CustomerID, 0, strProductCode, dblWeight, CLng(dblQuantity),
