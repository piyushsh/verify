...
Partial Class SalesOrderTemplateWoolworthsPDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strColNames(5) = "Qty"
        strColNames(6) = "Wgt"
        strColNames(7) = "Unit Price"
        strColNames(8) = "Tax"
        strColNames(9) = "Total"
        strColNames(10) = "Status"
            ...
            For intArrayCount = 0 To strColNames.Length - 1
                ...
                Select Case intArrayCount
                    ...
                    Case 3
                        ...
                        tableCellText.AddContent(" " + objCommon.GetWoolworthsSellBy(dsOrderItems.Tables(0).Rows(intRowCount).Item("ProductID")) + " ")
                    Case 4
                        tableCell.Width = New RelativeWidth(8)
                        tableCellText.AddContent(" " + objCommon.GetWoolworthsUseBy(dsOrderItems.Tables(0).Rows(intRowCount).Item("ProductID")) + " ")
