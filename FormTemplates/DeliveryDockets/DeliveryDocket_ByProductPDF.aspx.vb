...
Partial Class DeliveryDocket_ByProduct_TemplatePDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Sum Quantity/Weight per product
        Dim dtRepClone As DataTable = dtRep.Clone
        Dim dt As DataTable
        Dim strSearchMe As String
        Dim sumQuantity As Integer = 0
        Dim sumWeight As Double = 0
        'get a datatable of distinct ProductId's in dtTemp
        Dim dtUniqueProduct As DataTable = dtRep.DefaultView.ToTable(True, "ProductId")
        For intRowCount = 0 To dtUniqueProduct.Rows.Count - 1
            If Not IsDBNull(dtUniqueProduct.Rows(intRowCount).Item("ProductId"))  Then
                strSearchMe = "ProductId = " + dtUniqueProduct.Rows(intRowCount).Item("ProductId").ToString
                dt = objG.SearchDataTable(strSearchMe, dtRep)
                If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                    For intInnerRowCount = 0 To dt.Rows.Count - 1
                        If Not IsDBNull(dt.Rows(intInnerRowCount).Item("Quantity")) Then
                            sumQuantity = sumQuantity + dt.Rows(intInnerRowCount).Item("Quantity")
                        End If
                        If Not IsDBNull(dt.Rows(intInnerRowCount).Item("Weight")) Then
                            sumWeight = sumWeight + dt.Rows(intInnerRowCount).Item("Weight")
                        End If
                    Next
                    ...
                    Else
                        dt.Rows(0).Item("Quantity") = sumQuantity
                    End If


                    dt.Rows(0).Item("Weight") = sumWeight

                    dtRepClone.ImportRow(dt.Rows(0))
                    sumQuantity = 0
                    sumWeight = 0
                End If
            End If
        ...
        If intSalesOrderNumber > 0 Then
            ...
            For i = 0 To UBound(strSplit)
                If i <> UBound(strSplit) Then
                    ...
                    End If
                Else
                    strCleanedBillingAddress = strCleanedBillingAddress + Trim(strSplit(i))
                End If
            ...
            For i = 0 To UBound(strSplitShip)
                If i <> UBound(strSplitShip) Then
                    ...
                    End If
                Else
                    strCleanedShippingAddress = strCleanedShippingAddress + Trim(strSplitShip(i))
                End If
            Next i
            ...
            Dim strImg_Name As String = objCommonFuncs.GetConfigItem("TeleSalesDocketLogoPath")
            ...
            tableCell = tableRow.AddCell()
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 18), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            ...
            'Create TableInHeader  Row x (A blank row) 
            tableRow = tableInCell.AddRow()
            tableRow.Height = New FixedHeight(4)
            tableCell = tableRow.AddCell()
            tableCell.Width = New RelativeWidth(100)
            tableCellText = tableCell.AddText()
            tableCellText.AddContent(" ")
            ...
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            ...
            PageNo.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            ...
            PageNo.OffsetY = 100 + (lineCount * 19)
            PageNo.OffsetX = -133
            ...
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 12), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            ...
            'tableCell = tableRow.AddCell()
            'tableCell.Width = New RelativeWidth(21)
            'tableCellHeaderPattern.Apply(tableCell)
            'tableCellText = tableCell.AddText()
            'tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
            '    (New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            ...
            tableCell = tableRow.AddCell()
            tableCell.Width = New RelativeWidth(34)
            tableCellHeaderPattern.Apply(tableCell)
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                (New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            ...
            'tableCellPattern.Apply(tableCell)
            'tableCellText = tableCell.AddText()
            'tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            'tableCellText.Alignment = New TextAlignment(Alignment.Center, Alignment.Middle)
            ...
            strColNames(0) = " Product"
            strColNames(1) = " Quantity"
            strColNames(2) = " Weight"

            For intArrayCount = 0 To strColNames.Length - 1
                tableCell = tableRow.AddCell
                Dim tableHeaderCellText As IText = tableCell.AddText()
                tableCellHeaderPattern.Apply(tableCell)
                tableHeaderCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font _
                                                                                                 ("Arial Rounded MT Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableHeaderCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
                Select Case intArrayCount
                    Case 0
                        tableCell.Width = New RelativeWidth(54)
                    Case 1
            ...
            'add row to tableInFooter
            tableRow = table1Foot.AddRow()
            tableCell = tableRow.AddCell()
            tableCell.Width = New RelativeWidth(13)
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                    (New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            ...
            tableCellText = tableCell.AddText()
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
        (New Infragistics.Documents.Reports.Graphics.Font("Arial", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            ...
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
        (New Infragistics.Documents.Reports.Graphics.Font("Arial Rounded MT Bold", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.AddContent("Order Number")
            ...
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
        (New Infragistics.Documents.Reports.Graphics.Font("Arial", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.AddContent(intSalesOrderNumber)
            ...
            End If
            Dim strFileName As String = filePath + "\DeliveryDocket_ByProduct_User" + Session("_VT_CurrentUserId").ToString() + ".pdf"
            Dim strFileNameWeb As String = strRootPathWeb + "\Published\DeliveryDocket_ByProduct_User" + Session("_VT_CurrentUserId").ToString() + ".pdf"
