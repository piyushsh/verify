...
Partial Class DeliveryDocket_AliyasHACCPTemplatePDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If intSalesOrderNumber > 0 Then
            ...
            If Not IsDBNull(dtSalesOrder.Rows(0).Item("CustomerName")) Then
                strCustomerName = dtSalesOrder.Rows(0).Item("CustomerName")
            End If

            Dim strDeliveryName As String = ""
            If Not IsDBNull(dtSalesOrder.Rows(0).Item("DeliveryCustomerName")) Then
                strDeliveryName = dtSalesOrder.Rows(0).Item("DeliveryCustomerName")
            End If

            Dim strCleanedBillingAddress As String = ""
            If Not IsDBNull(dtSalesOrder.Rows(0).Item("BillingAddress")) Then
            ...
            If Not IsDBNull(dtSalesOrder.Rows(0).Item("DeliveryCustomerAddress")) Then
            ...
            Dim strImg_Name As String = objCommonFuncs.GetConfigItem("TeleSalesHACCPDocketLogoPath")
            ...
            tableCellText.AddContent("Packing Slip")
            ...
            tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            tableCellText.AddContent("Cust P/O #:")
            ...
            PageNo.Style = New Infragistics.Documents.Reports.Report.Text.Style(New Infragistics.Documents.Reports.Graphics.Font("Arial", 10), Infragistics.Documents.Reports.Graphics.Brushes.Black)
            ...
            'PageNo.OffsetX = -113
            PageNo.OffsetY = 122 + (lineCount * 10)
            PageNo.OffsetX = -125
            ...
            If Not IsDBNull(dtCustDetails.Rows(0).Item("PaymentTerms")) AndAlso Not dtCustDetails.Rows(0).Item("PaymentTerms").ToString = "" Then
                Dim strPaymentTerms = dtCustDetails.Rows(0).Item("PaymentTerms")
                'get the last two characters, check are they digits

                strPaymentTerms = strPaymentTerms.substring(strPaymentTerms.length - 2)
            ...
            tableCellText.Alignment = _
              New TextAlignment(Alignment.Center, Alignment.Middle)
            tableCellText.AddContent("Issued By")
            ...
            For intArrayCount = 0 To strColNames.Length - 1
                ...
                Select Case intArrayCount
                    ...
                    Case 0
                        tableCell.Width = New RelativeWidth(11)
                    Case 1
                        tableCell.Width = New RelativeWidth(14)
                    Case 2
                        tableCell.Width = New RelativeWidth(39)
                    Case 3
                        tableCell.Width = New RelativeWidth(12)
                    Case 4
                        tableCell.Width = New RelativeWidth(6)
            ...
            If dtReturns.Rows.Count > 0 Then
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
                tableCellText.AddContent("NUMBER OF PALLETS___________________________ ")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
                tableCellText.AddContent("NUMBER OF CHEP PALLETS___________________________ ")
         ...
         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
                tableCellText.AddContent("SHIPPED BY_________________________________________ ")
         ...
         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 9), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
                tableCellText.AddContent("DRIVERS SIGNATURE ______________________________________ ")
                ...
                'add a table for HACCP information (to be manually filled in by customer)
                Dim table3 As ITable = Band1.AddTable()
                table3.ApplyPattern(tablePattern)
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("Product is:  REFRIGERATED or FROZEN")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("TEMP________°C")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("TRAILER Temperature________°C")
                ...
                tableCellText = tableCell.AddText()
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 5), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent(" ")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("TRAILER CONDITION:   SATISFACTORY / UNSATISFACTORY")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("PRODUCT SHIPPED BY SHIPPING SOPS:  YES / NO")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("CORRECTIVE ACTIONS FOR UNSATISFACTORY CONDITIONS (WITH INITIAL DATE)________________________________________")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("VERIFIED BY ______________________________________")
                ...
                tableCellText.Style = New Infragistics.Documents.Reports.Report.Text.Style _
                         (New Infragistics.Documents.Reports.Graphics.Font("Arial Bold", 8), Infragistics.Documents.Reports.Graphics.Brushes.Black)
                tableCellText.AddContent("DATE VERIFIED _________________________________ ")
