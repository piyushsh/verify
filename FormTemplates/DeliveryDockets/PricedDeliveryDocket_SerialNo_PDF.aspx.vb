...
Partial Class PricedDeliveryDocket_SerialNo_TemplatePDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dtRep IsNot Nothing AndAlso dtRep.Rows.Count > 0 Then
            dtRep.Columns.Add("SerialNum")
            For intRowCount = 0 To dtRep.Rows.Count - 1
                If Not IsDBNull(dtRep.Rows(intRowCount).Item("TransactionId")) Then
                    ds = objTrace.GetTransactionForId(dtRep.Rows(0).Item("TransactionId"))
                    If Not IsDBNull(ds.Tables(0).Rows(0).Item("SerialNum")) Then
                        dtRep.Rows(intRowCount).Item("SerialNum") = ds.Tables(0).Rows(0).Item("SerialNum")
                    End If
                End If
            Next
        End If
        ...
        If intSalesOrderNumber > 0 Then
            ...
            tableCellText.Alignment = New TextAlignment(Alignment.Left, Alignment.Middle)
            Dim strDocketNum As String = If(IsDBNull(dtRep.Rows(0).Item("DocketNum")), "", dtRep.Rows(0).Item("DocketNum"))

            tableCellText.AddContent(strDocketNum)
            ...
            If Not IsDBNull(dtCustDetails.Rows(0).Item("PaymentTerms")) Then
                ...
                If strOutput <> "" Then
                    ...
                    dteInvoice = dtRep.Rows(0).Item("DateOfTransaction")
                    Dim IntervalPaymentTerms As DateInterval = strOutput
                    dteDueDate = DateAdd("d", dlbOutput, dteInvoice)
            ...
            Dim strColNames(9) As String
            'strColNames(0) = "ITEM NO"
            strColNames(0) = "Product Code"
            strColNames(1) = "Trace Code"
            strColNames(2) = "Serial No"
            strColNames(3) = "Product Name"
            strColNames(4) = "Comments"
            strColNames(5) = "Wt Unit"
            If blnUsePricing Then
            ...
            For intArrayCount = 0 To strColNames.Length - 1
                ...
                Select Case intArrayCount
                    ...
                    Case 2
                        tableCell.Width = New RelativeWidth(10) 'serial Num

                    Case 3
                        tableCell.Width = New RelativeWidth(17)
                    Case 4
                        tableCell.Width = New RelativeWidth(19)
                    Case 5
                        tableCell.Width = New RelativeWidth(6)
                    Case 6
                ...
                For intArrayCount = 0 To strColNames.Length - 1
                    ...
                    Select Case intArrayCount
                        ...
                        Case 2
                            ...
                            tableCellText.AddContent(" " + dtRep.Rows(intRowCount).Item("SerialNum").ToString + " ")
                        Case 3
                            tableCell.Width = New RelativeWidth(17)
