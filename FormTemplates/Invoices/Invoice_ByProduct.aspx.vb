...
Partial Class Invoice_ByProductTemplatePDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim sumTotalPrice As Double = 0
        'get a datatable of distinct ProductId's in dtTemp
        Dim View As New DataView(dtRep)

        Dim dtUniqueProduct As DataTable = View.ToTable(True, "ProductId", "PriceCharged")
        ...
        For intRowCount = 0 To dtUniqueProduct.Rows.Count - 1
            If Not IsDBNull(dtUniqueProduct.Rows(intRowCount).Item("ProductId")) AndAlso Not IsDBNull(dtUniqueProduct.Rows(intRowCount).Item("PriceCharged")) Then
                strSearchMe = "ProductId = " + dtUniqueProduct.Rows(intRowCount).Item("ProductId").ToString + " AND PriceCharged = " + _
                     dtUniqueProduct.Rows(intRowCount).Item("PriceCharged").ToString
                ...
                If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                    For intInnerRowCount = 0 To dt.Rows.Count - 1
                        ...
                        End If
                        If Not IsDBNull(dt.Rows(intInnerRowCount).Item("TotalPrice")) Then
                            sumTotalPrice = sumTotalPrice + dt.Rows(intInnerRowCount).Item("TotalPrice")
                        End If
                    ...
                    dt.Rows(0).Item("TotalPrice") = sumTotalPrice
        ...
        If intSalesOrderNumber > 0 Then
            ...
            Dim strHeaderTextPath As String = objCommonFuncs.GetConfigItem("TeleSalesInvoiceHeaderTextPath")
            ...
            Dim strColNames(6) As String
            strColNames(0) = "Product Code"
            strColNames(1) = "Product Name"
            strColNames(2) = "Comments"
            strColNames(3) = "Unit Price"
            strColNames(4) = "Qty"
            strColNames(5) = "Wgt"
            strColNames(6) = "TOTAL"
            ...
            If dtReturns.Rows.Count > 0 Then
                ...
                Dim strFooterPath As String = objCommonFuncs.GetConfigItem("TeleSalesInvoiceFooterTxtPath")
                ...
                Dim strImg_NameFooter As String = objCommonFuncs.GetConfigItem("TeleSalesInvoiceFooterLogoPath")
            ...
            End If
            Dim strFileName As String = filePath + "\Invoice_ByProduct_User" + Session("_VT_CurrentUserId").ToString() + ".pdf"
            Dim strFileNameWeb As String = strRootPathWeb + "\Published\Invoice_ByProduct_User" + Session("_VT_CurrentUserId").ToString() + ".pdf"
